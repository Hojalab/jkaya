 ...
 *
 * Copyright (c) 2009-2013 Mark Francis
 *
 * LICENSE:
 *jkaya  is free software: you can redistribute it and/or modify it under the terms of the GNU General Public
 ...
 *
 *
 * @author Mark francis <mark[at]bitterpill[dot]org>
 * @license http://www.gnu.org/licenses/gpl.html
 * @copyright 2009-2013 Mark Wilkie
 */
require_once dirname(__FILE__).'/init.tests.php';
require_once jkaya_WEBAPP_PATH.'_lib/extlib/simpletest/autorun.php';
require_once jkaya_WEBAPP_PATH.'config.inc.php';
